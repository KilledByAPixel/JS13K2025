...
function engineInit()
{
    ...
    function engineUpdate(frameTimeMS=0)
    {
        ...
        const debugSpeedUp   = debug && keyIsDown('NumpadAdd');      // + skip ahead
        const debugSpeedDown = debug && keyIsDown('NumpadSubtract'); // - slow down
    ...
    function updateCanvas()
    {
        ...
        // force root element to correct size
        //rootElement.style.width  = innerWidth  + 'px';
        //rootElement.style.height = innerHeight + 'px';
