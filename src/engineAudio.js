...
/** 
 * Sound Object - Stores a sound for later use
 * 
...
class Sound
{
     ...
     *  @return {AudioBufferSourceNode} - The audio source node
     */
    playNote(semitoneOffset, volume)
    { return this.play(volume, 2**(semitoneOffset/12), 0); }
...
/** 
 * Sound Wave Object - Stores a wave sound for later use
...
class SoundWave extends Sound
{
     ...
     */
    constructor(filename, randomness=0, onloadCallback)
    {
        super();
        if (!soundEnable || headlessMode) return;
